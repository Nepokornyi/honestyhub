...
export const BlobBackground = ({ children }: BlobBackgroundProps) => {
    return (
        <div className="group absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] flex justify-center items-center clip-blob">
            {children}

            <span className="absolute border-2 border-white w-[400px] h-[400px] top-0 left-0 transition-all duration-500 animate-square-blob rounded-[32%_58%_69%_43%/_48%_32%_59%_55%] group-hover:border-none group-hover:bg-blue-300" />
